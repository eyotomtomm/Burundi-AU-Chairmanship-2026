...
<h1 style="margin:0;color:#ffffff;font-size:22px;font-weight:700;letter-spacing:0.5px;">Be 4 Africa</h1>
...
def seed_email_templates(apps, schema_editor):
    ...
    templates = [
        {
            'key': 'welcome',
            'subject': 'Welcome to Be 4 Africa',
...
Thank you for joining the Be 4 Africa app. We are delighted to have you as part of our community.
</p>
<p style="color:#374151;font-size:15px;line-height:1.7;margin:0 0 24px;">
Stay informed about the latest events, news, and initiatives with Be 4 Africa.
</p>
...
If you have any questions, feel free to reach out to our support team through the app.
            ...
            'body_html_fr': '',
            'body_text': 'Welcome to Be 4 Africa, {{ username }}! Thank you for joining our community.',
            'body_text_fr': '',
            'is_active': True,
        },
        {
