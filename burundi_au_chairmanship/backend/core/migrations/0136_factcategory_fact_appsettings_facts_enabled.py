...
class Migration(migrations.Migration):
    ...
    # This whole migration is a repair pass for the production Postgres schema,
    # which grew these tables outside the migration tracker; 0135 already creates
    # them the ordinary way. The SQL is Postgres-only (IF NOT EXISTS, bigserial,
    # now()), so on any other backend — a sqlite test database — there is nothing
    # to repair and nothing to do.
    operations = (
