...
class _AriseInitiativeScreenState extends State<AriseInitiativeScreen> {
  ...
  // Theme colors for A-RISE Initiative
  static const _primary = Color(0xFFB8860B);
  static const _primaryLight = Color(0xFFDAA520);
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (_t('overview').isNotEmpty) ...[
                              _buildSectionHeader(
                                _isFr ? 'À Propos de A-RISE' : 'About A-RISE',
                            ...
                            if (_tList('objectives').isNotEmpty) ...[
                              _buildSectionHeader(
                                _isFr ? 'Piliers Stratégiques' : 'Strategic Pillars',
                            ...
                            if (_tList('impact_areas').isNotEmpty) ...[
                              _buildSectionHeader(
                                _isFr ? 'Domaines Prioritaires' : 'Focus Areas',
                                Icons.hub_rounded,
                                isDark,
                              ),
                              const SizedBox(height: 12),
                            ...
                            if (_t('current_initiatives').isNotEmpty) ...[
                              _buildSectionHeader(
                                _isFr ? 'Résultats Attendus' : 'Expected Outcomes',
        ...
        background: Stack(
          ...
          children: [
            ...
            Positioned(
              right: 24,
              bottom: 64,
              child: Icon(Icons.trending_up, size: 60, color: Colors.white.withValues(alpha: 0.15)),
            ),
          ],
        ),
      ),
    ...
    return Row(
      children: [
        Container(
          ...
          child: Icon(icon, size: 20, color: isDark ? _primaryLight : _primary),
        ),
        ...
        Expanded(
          child: Text(
            ...
            style: TextStyle(
              fontSize: 22,
              fontWeight: FontWeight.w800,
              color: isDark ? _primaryLight : _primary,
              letterSpacing: -0.3,
            ),
          ),
        ),
